<div class="container_main">
	...
	<div class="elementor-widget-container">
		<div class="bdt-ep-accordion-container">
			<div id="bdt-ep-accordion-4f04ee7" class="bdt-ep-accordion bdt-accordion" data-bdt-accordion="{"
				collapsible":true,"multiple":false,"transition":"ease-in-out"}" data-settings="{"
				id":"bdt-ep-accordion-4f04ee7","activeHash":"no","activeScrollspy":null,"hashTopOffset":false,"hashScrollspyTime":false}">
				...
				<div class="bdt-ep-accordion-item">
					...
					<div class="bdt-ep-accordion-content bdt-accordion-content">
						<div data-elementor-type="section" data-elementor-id="263" class="elementor elementor-263">
							...
							<?php include "./includes/works/eyebrows/brows.php"; ?>
						</div>
					</div>
				</div>
				...
				<div class="bdt-ep-accordion-item">
					...
					<div class="bdt-ep-accordion-content bdt-accordion-content">
						<div data-elementor-type="section" data-elementor-id="262" class="elementor elementor-262">
							...
							<?php include "./includes/works/cosmetology/piling.php"; ?>
							...
							<?php include "./includes/works/cosmetology/micronidling.php"; ?>
